...
export const Navigation = () => {
  ...
  const aboutItems = [
    { label: "Beltud", href: "#beltud" },
    { label: language === "nl" ? "Lidmaatschap" : "Adhésion", href: "#lidmaatschap" },
    { label: language === "nl" ? "Gastenboek" : "Livre d'or", href: "#gastenboek" },
  ];

  const projectItems = [
    { label: language === "nl" ? "50 Jaar in België" : "50 ans en Belgique", href: "#50-jaar" },
    { label: language === "nl" ? "Brusselse Cultuurdag" : "Journées culturelles bruxelloises", href: "#brusselse-cultuurdag" },
    { label: language === "nl" ? "Cartoonconcours" : "Concours de BD", href: "#cartoon-concours" },
    { label: language === "nl" ? "De Kleuren van België" : "Les couleurs de la Belgique", href: "#kleuren-van-belgie" },
    { label: language === "nl" ? "Vriendschappelijke wedstrijd" : "Match amical", href: "#vriendschappelijke-wedstrijd" },
  ];
  ...
  const courseItems = [
    { label: language === "nl" ? "Turks voor beginners" : "Turc pour débutants", href: "#turks-beginners" },
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="hidden lg:flex items-center space-x-1">
            <NavigationMenu>
              <NavigationMenuList className="space-x-1">
                <NavigationMenuItem>
                  <a href="#" className="px-4 py-2 text-sm font-medium text-primary hover:text-primary/80 transition-colors rounded-md hover:bg-muted inline-flex items-center">
                ...
                <NavigationMenuItem>
                  <a href="#diary" className="px-4 py-2 text-sm font-medium text-primary hover:text-primary/80 transition-colors rounded-md hover:bg-muted">
                ...
                <NavigationMenuItem>
                  <a href="#multimedia" className="px-4 py-2 text-sm font-medium text-primary hover:text-primary/80 transition-colors rounded-md hover:bg-muted">
                    Multimedia
                  </a>
                </NavigationMenuItem>

                <NavigationMenuItem>
                  <a href="#contact" className="px-4 py-2 text-sm font-medium text-primary hover:text-primary/80 transition-colors rounded-md hover:bg-muted">
                    Contact
                  </a>
                </NavigationMenuItem>
              </NavigationMenuList>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden py-4 space-y-3">
            <a href="#" className="block px-4 py-2 text-sm font-medium text-primary hover:bg-muted rounded-md" onClick={() => setMobileMenuOpen(false)}>
            ...
            <div>
              ...
              {aboutItems.map((item) => (
                <a key={item.href} href={item.href} className="block px-8 py-2 text-sm text-muted-foreground hover:bg-muted rounded-md" onClick={() => setMobileMenuOpen(false)}>
                  {item.label}
                </a>
              ))}
            </div>

            <a href="#diary" className="block px-4 py-2 text-sm font-medium text-primary hover:bg-muted rounded-md" onClick={() => setMobileMenuOpen(false)}>
              {language === "nl" ? "Dagboek" : "Journal"}
            </a>
            ...
            <a href="#multimedia" className="block px-4 py-2 text-sm font-medium text-primary hover:bg-muted rounded-md" onClick={() => setMobileMenuOpen(false)}>
              Multimedia
            </a>

            <a href="#contact" className="block px-4 py-2 text-sm font-medium text-primary hover:bg-muted rounded-md" onClick={() => setMobileMenuOpen(false)}>
              Contact
            </a>
          </div>
        )}
